...
function efa_admin_scripts() {
    ...
    wp_register_script('eds-font-awesome-js-private', plugins_url('/js/private/eds-font-awesome.js',__FILE__),
    array('jquery'),'',true);
	...
	// Popper
	wp_register_script('bootstrap-popper', plugins_url('/lib/bootstrap/js/popper.min.js',__FILE__),
    array('jquery'),'',true);

	// Bootstrap js
	wp_register_script('bootstrap-cdn', plugins_url('/lib/bootstrap/js/bootstrap.min.js',__FILE__),
    array('jquery'),'',true);
