...
function eds_font_awesome_shortcode($atts, $content = '')
{
    ...
    $output = '<i class="' . esc_attr( $att['style'] ) . ' fa-' . esc_attr( $att['name'] ) . ' fa-' . esc_attr( $att['size'] ) .
        '"></i>';
    return $output;
}																														//!SECTION END OF 2.2
...
function eds_font_awesome_mask_shortcode($attr, $content = '')
{
    ...
    $output = '
        <div class="fa-' . esc_attr( $attr['size'] ) . '">
            <i class="' . esc_attr( $attr['inner_style'] ) . ' fa-' . esc_attr( $attr['inner_icon'] ) . '" data-fa-transform="' . esc_attr( $attr['grow_shrink'] ) . '-' . esc_attr( $attr['gs_value'] ) . ' ' . esc_attr( $attr['position'] ) . '-' . esc_attr( $attr['position_value'] ) .
        '" data-fa-mask="' . esc_attr( $attr['outer_style'] ) . ' fa-' . esc_attr( $attr['outer_icon'] ) . '" style="background:' . esc_attr( $attr['bg_color'] ) . '"></i>
...
function eds_font_awesome_mask_circle_shortcode($attr)
{
    ...
    $output = '
		<div class="fa-' . esc_attr( $attr['size'] ) . '">
			<i class="' . esc_attr( $attr['style'] ) . ' fa-' . esc_attr( $attr['name'] ) . '" data-fa-transform="' . esc_attr( $attr['grow_shrink'] ) . '-' . esc_attr( $attr['gs_value'] ) . ' ' . esc_attr( $attr['position'] ) . '-' . esc_attr( $attr['position_value'] ) . '" data-fa-mask="fas fa-circle" style="background:' . esc_attr( $attr['bg_color'] ) . '"></i>
		</div>
...
function eds_font_awesome_rotate_icon_shortcode($attr)
{
    ...
    $output = '
		...
		<div class="fa-' . esc_attr( $attr['size'] ) . '">
			<i class="' . esc_attr( $attr['style'] ) . ' fa-' . esc_attr( $attr['name'] ) . ' fa-' . esc_attr( $attr['rotation_amount'] ) . '"></i>
		</div>
	';
