...
<h1 style="text-align:center; color:'. esc_attr( $attr['color'] ) .'; margin-bottom:1px;">'. esc_html( $attr['text'] ) .'</h1>';
	...
	if(get_option("social-share-facebook") == 1){
  	...
  	if(get_option("social-share-twitter") == 1){
		$content .= '<a href="http://twitter.com/intent/tweet?text='.$sb_title.'&amp;url='. $current_url .'&amp;via='. esc_attr( $attr['twitter'] ) .'" class="icon twitter">
...
function social_share_settings()
{
    ...
    add_settings_field("social-share-instagram", "Instagram:", "social_share_instagram_checkbox", "social-share", "social_share_config_section");
	add_settings_field("social-share-github", "GitHub:", "social_share_github_checkbox", "social-share", "social_share_config_section");
	add_settings_field("social-share-youtube", "YouTube:", "social_share_youtube_checkbox", "social-share", "social_share_config_section");
    ...
    add_settings_field("social-share-mail", "Mail:", "social_share_mail_checkbox", "social-share", "social_share_config_section");
    add_settings_field("social-share-print", "Print:", "social_share_print_checkbox", "social-share", "social_share_config_section");
...
// GitHub Checkbox
function social_share_github_checkbox()
{  
   ?>
